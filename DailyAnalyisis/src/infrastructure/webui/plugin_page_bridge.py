...
class PluginPageWebUIBridge:
    ...
    def __init__(
        ...
        self.authenticator = WebUIAuthenticator(
            ...
            enabled_reader=self._read_gscore_webui_enabled,
        )
